...
function fncAddProduct(){
	...
	$(function(){
		 $( "div button:contains('등록')" ).on("click" , function() {
				//Debug..
				alert("ㅇㅇ" );
				fncAddProduct();
			});
	...
	$(function(){
		$( "div.btn btn-primary btn:contains('취소')" ).on("click" , function() {
			 //Debug..
				alert("ㅇㅇ" );
				$("form")[0].reset();	
			});
		...
		<div class="form-group">
		 ...
		 <div class="form-group">
		  ...
		  <div class="form-group">
		    ...
		    <div class="col-sm-4">
		      <input type="file" class="form-control" id="fileName" name="fileName" placeholder="이미지 파일을 선택하세요">
		    </div>
		  </div>
